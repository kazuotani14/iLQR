/*
clang and osx default g++ don't come with openmp
g++-7 -std=c++11 -I ../include/eigen -fopenmp try_openmp_finite_diff.cpp -o try_openmp_finite_diff
*/
...
int main(int argc, char *argv[]) {
  ...
  // for some reason, 20 works better than 4 (number of cores)
  #pragma omp parallel for num_threads(4)// about 2x speedup with this
